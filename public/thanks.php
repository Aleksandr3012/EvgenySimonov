...
<html lang="ru">
	<head>
		...
		<link rel="shortcut icon" type="image/ico" href="img/favicon/logo.ico"><meta name=”viewport” content=”width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
				...
				<div class="topLine" id="topLine">
					<div class="container">
						<div class="row justify-content-between">
							<div class="col d-flex align-items-center"><a class="topLine__logo" href="/"><img class="rs-i" src="img/svg/logo-top.svg" alt=""/></a>
